...
const RIGS = [
  ...
  { name: 'secondpeak_cliff_surfline', hash: `preset=secondpeak&cam=cliff&day=overhead&h0=0.914&tide=0.357&${COMMON}`, settle: 2 },
  { name: 'secondpeak_cliff_setwave', hash: `preset=secondpeak&cam=cliff&day=overhead&h0=1.40&tide=0.500&${COMMON}`, settle: 2 },
];
const ARMS = [
  { name: 'default', flag: '' },
  { name: 'bore', flag: '&bore=1' },
  { name: 'tubeclassic', flag: '&tube=1&classic=1&descent=1' },
  { name: 'sections', flag: '&gapfix=1&sectioncurl=1' },
  { name: 'all', flag: '&tube=1&classic=1&descent=1&bore=1&crash=1&gapfix=1&sectioncurl=1' },
];
