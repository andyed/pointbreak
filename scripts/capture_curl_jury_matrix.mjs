...
const ARMS = [{ name: 'default', flag: '' }, { name: 'classicdescent', flag: '&classic=1&descent=1' }, { name: 'tube', flag: '&tube=1' }, { name: 'tubeclassic', flag: '&tube=1&classic=1&descent=1' }];
